...
v3 — Améliorations :
  ...
  - prob_bookie retiré des FEATURE_COLS (indépendance du modèle)
  - Nouvelles features under-spécifiques ajoutées
  - min_train_seasons augmenté à 5
  - scale_pos_weight pour rééquilibrer under/over
  - Hyperparamètres retravaillés
"""
